  ...
  return (
    <div className="relative">
      <section className="">
        ...
        <div className="text-center bg-[#0F2F63] md:p-5 p-3 leading-tight text-gray-200 tracking-widest">
          <h1 className="md:mb-4 mb-2 md:pb-2 md:text-3xl text-xl font-bold text-red-500 border-b-2 border-gray-200 w-[50%] relative m-auto">
            WELCOME!!!
          </h1>
          ...
          <p
            className="text-sm md:text-lg font-bold mt-2 bg-red-500"
            data-aos="fade-up"
      ...
      <section>
        <div className="flex flex-wrap gap-5 md:gap-0 md:px-10 md:py-16 p-5 justify-around tracking-wider font-bold cursor-pointer">
          <div className="flex flex-col items-center">
            <p className="md:text-4xl text-red-500  text-2xl md:hover:translate-y-1 transition-all duration-300">
              4000
            </p>
            <p className="md:text-lg text-sm">Exhibitors</p>
          </div>
          <div className="flex flex-col items-center">
            <p className="md:text-4xl text-red-500  text-2xl md:hover:translate-y-1 transition-all duration-300">
              85
            </p>
            <p className="md:text-lg text-sm">Exhibiting Countries</p>
          </div>
          <div className="flex flex-col items-center">
            <p className="md:text-4xl text-red-500  text-2xl md:hover:translate-y-1 transition-all duration-300">
              60,000
            </p>
            <p className="md:text-lg text-sm">Live Visitors</p>
          </div>
          <div className="flex flex-col items-center">
            <p className="md:text-4xl text-red-500  text-2xl md:hover:translate-y-1 transition-all duration-300">
              10
            </p>
            <p className="md:text-lg text-sm">Conferences</p>
          </div>
        </div>
        <div className="md:px-10 md:py-16 flex flex-col items-center w-full bg-[#0F2F63]">
          <h1 className="text-center md:text-4xl font-bold text-red-500">
            Why Visit?
          </h1>
          <div className="flex justify-around gap-10 w-full mt-10">
          ...
          <div className="flex justify-between items-center my-20 gap-10 w-full">
          ...
          <Link to="exhibit">
            <button className="flex gap-1 items-center text-xl bg-red-500 hover:bg-red-400 transition-all duration-300 text-gray-200 mt-10 p-2 rounded-xl">
              Learn More
      ...
      <section className="md:my-20 md:mx-20">
        <div className="flex justify-between">
          <div className="md:w-1/3 flex flex-col items-center">
            <figure className="md:w-full md:h-full shadow-lg">
              <img
